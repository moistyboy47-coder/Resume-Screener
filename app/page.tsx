    ...
    <div className="space-y-8">
      ...
      <div className="bg-white shadow rounded-lg p-6 border border-gray-100">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Upload candidate PDF resumes to automatically parse details, evaluate
          against role requirements using Gemini 2.5 Flash, calculate weighted
          scores, and rank candidates.
        </p>
        <div className="flex flex-wrap gap-2 text-xs font-medium text-gray-700">
          <span className="bg-gray-100 px-3 py-1 rounded-full">
            Min Exp: {currentJob.min_years_experience} Years
          </span>
